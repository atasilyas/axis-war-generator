...
public class BLZServiceLocator extends org.apache.axis.client.Service implements com.thomas_bayer.blz.BLZService {
    ...
    // Use to get a proxy class for BLZServiceSOAP12port_http
    private java.lang.String BLZServiceSOAP12port_http_address = "http://www.thomas-bayer.com/axis2/services/BLZService";

    public java.lang.String getBLZServiceSOAP12port_httpAddress() {
        return BLZServiceSOAP12port_http_address;
    }

    // The WSDD service name defaults to the port name.
    private java.lang.String BLZServiceSOAP12port_httpWSDDServiceName = "BLZServiceSOAP12port_http";

    public java.lang.String getBLZServiceSOAP12port_httpWSDDServiceName() {
        return BLZServiceSOAP12port_httpWSDDServiceName;
    }

    public void setBLZServiceSOAP12port_httpWSDDServiceName(java.lang.String name) {
        BLZServiceSOAP12port_httpWSDDServiceName = name;
    }

    public com.thomas_bayer.blz.BLZServicePortType getBLZServiceSOAP12port_http() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
            endpoint = new java.net.URL(BLZServiceSOAP12port_http_address);
        }
        catch (java.net.MalformedURLException e) {
            throw new javax.xml.rpc.ServiceException(e);
        }
        return getBLZServiceSOAP12port_http(endpoint);
    }

    public com.thomas_bayer.blz.BLZServicePortType getBLZServiceSOAP12port_http(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.thomas_bayer.blz.BLZServiceSOAP12BindingStub _stub = new com.thomas_bayer.blz.BLZServiceSOAP12BindingStub(portAddress, this);
            _stub.setPortName(getBLZServiceSOAP12port_httpWSDDServiceName());
            return _stub;
        }
        catch (org.apache.axis.AxisFault e) {
            return null;
    ...
    public void setBLZServiceSOAP12port_httpEndpointAddress(java.lang.String address) {
        BLZServiceSOAP12port_http_address = address;
    }
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            ...
            if (com.thomas_bayer.blz.BLZServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.thomas_bayer.blz.BLZServiceSOAP12BindingStub _stub = new com.thomas_bayer.blz.BLZServiceSOAP12BindingStub(new java.net.URL(BLZServiceSOAP12port_http_address), this);
                _stub.setPortName(getBLZServiceSOAP12port_httpWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        else if ("BLZServiceSOAP12port_http".equals(inputPortName)) {
            return getBLZServiceSOAP12port_http();
        }
        else  {
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://thomas-bayer.com/blz/", "BLZServiceSOAP12port_http"));
        }
...
if ("BLZServiceSOAP12port_http".equals(portName)) {
            setBLZServiceSOAP12port_httpEndpointAddress(address);
        }
        else 
{ // Unknown Port Name
